...
class Range_Bearing():
    def __init__(self,deltaTheta_epuck0=0,deltaTheta_epuck1=0,deltaSteps_epuck0=0,deltaSteps_epuck1=0,deltaTheta_epuck2=0,deltaTheta_epuck3=0,deltaSteps_epuck2=0,deltaSteps_epuck3=0, filtered_epuck0=matrix([0.372, -0.147 ,0]),filtered_epuck1=matrix([0.305, -0.1624 ,0]), filtered_epuck2=matrix([0.2682, -0.025,0]),filtered_epuck3=matrix([0.340, -0.0235 ,0]), covariance_epuck0=np.array([[0.00001, 0, 0],[0, 0.00001, 0],[0, 0, 0.00001]]), covariance_epuck1=np.array([[0.00001, 0, 0],[0, 0.00001, 0],[0, 0, 0.00001]]),covariance_epuck2=np.array([[0.00001, 0, 0],[0, 0.00001, 0],[0, 0, 0.00001]]), covariance_epuck3=np.array([[0.00001, 0, 0],[0, 0.00001, 0],[0, 0, 0.00001]]), init_xpos_epuck0=0.372, init_ypos_epuck0=-0.147, init_theta_epuck0=0,init_xpos_epuck1=0.305, init_ypos_epuck1=-0.1624, init_theta_epuck1=0, init_xpos_epuck2=0.2682, init_ypos_epuck2=-0.025, init_theta_epuck2=0,init_xpos_epuck3=0.340, init_ypos_epuck3=-0.0235, init_theta_epuck3=0, yaw_epuck0=0, yaw_epuck1=0, yaw_epuck2=0, yaw_epuck3=0, camera_epuck0=matrix([0.378, -0.1293 ,0]), camera_epuck1=matrix([0.311, -0.145 ,0]), camera_epuck2=matrix([0.268, -0.010,0]), camera_epuck3=matrix([0.3400, -0.006 ,0]), flag_epuck0=0, flag_epuck1=0, flag_epuck2=0, flag_epuck3=0, Z_epuck0=0,Z_epuck1=0, Z_epuck2=0,Z_epuck3=0, alpha_0=0,Beta_0=0, alpha_1=0,Beta_1=0, alpha_2=0,Beta_2=0, alpha_3=0,Beta_3=0):
	  ...
	  self.ut_epuck2=[0,0]
          ...
          self.led_epuck0=rospy.Publisher('/epuck2_robot_0/mobile_base/rgb_leds',UInt8MultiArray,queue_size=10)
          self.led_epuck1=rospy.Publisher('/epuck2_robot_1/mobile_base/rgb_leds',UInt8MultiArray,queue_size=10)
          self.led_epuck2=rospy.Publisher('/epuck2_robot_2/mobile_base/rgb_leds',UInt8MultiArray,queue_size=10)
          self.led_epuck3=rospy.Publisher('/epuck2_robot_3/mobile_base/rgb_leds',UInt8MultiArray,queue_size=10)
...
#########################################################################################
    ...
    def   Localization_epuck0(self, ut_epuck0, x_pos_epuck0, y_pos_epuck0, theta_epuck0,flag_epuck0):
                                ...
                                if(self.second_run_epuck0):
                                      self.previous_range_epuck0 = Z_range_epuck0
                                      self.previous_bearing_epuck0 = Z_bearing_epuck0_norm
                                current_range_epuck0 = Z_range_epuck0
                                current_bearing_epuck0 = Z_bearing_epuck0_norm
 
                                if sqrt((current_range_epuck0 - self.previous_range_epuck0) * (current_range_epuck0 - self.previous_range_epuck0)) >                      self.Gamma_range*sqrt(self.previous_range_epuck0*self.previous_range_epuck0) + self.Delta_range:
                                       range_epuck0 = current_range_epuck0
         
                                else:
                                       range_epuck0 = self.previous_range_epuck0
         
                                if sqrt((current_bearing_epuck0 - self.previous_bearing_epuck0) * (current_bearing_epuck0 - self.previous_bearing_epuck0)) >  self.Gamma_bearing*sqrt(self.previous_bearing_epuck0*self.previous_bearing_epuck0) + self.Delta_bearing:
                                       bearing_epuck0 = current_bearing_epuck0
         
                                else:
                                       bearing_epuck0 = self.previous_bearing_epuck0

                                self.previous_range_epuck0 = range_epuck0
                                self.previous_bearing_epuck0 = bearing_epuck0
                                self.second_run_epuck0 = False

                                self.alpha_0 = bernoulli.rvs(0.5)
                                self.Beta_0 = bernoulli.rvs(0.1)
                                self.Z_epuck0=[self.alpha_0*range_epuck0 + (1-self.alpha_0)*self.Beta_0*(-range_epuck0+10),self.alpha_0*bearing_epuck0 + (1-self.alpha_0)*self.Beta_0*(-bearing_epuck0+10)]
                                ...
                                if (self.flag_epuck0!= 0):
                                      ...
                                      self.theta_epuck0,self.camera_epuck0,self.flag_epuck0,self.alpha_0,self.Beta_0)
                                self.movingRobot=None
                                self.stationaryRobot=None
	                        self.ut=[0,0]
    ...
    def   Localization_epuck1(self, ut_epuck1, x_pos_epuck1, y_pos_epuck1, theta_epuck1,flag_epuck1):
                                ...
                                if(self.second_run_epuck1):
                                      self.previous_range_epuck1 = Z_range_epuck1
                                      self.previous_bearing_epuck1 = Z_bearing_epuck1_norm
                                current_range_epuck1 = Z_range_epuck1
                                current_bearing_epuck1 = Z_bearing_epuck1_norm
 
                                if sqrt((current_range_epuck1 - self.previous_range_epuck1) * (current_range_epuck1 - self.previous_range_epuck1)) >                      self.Gamma_range*sqrt(self.previous_range_epuck1*self.previous_range_epuck1) + self.Delta_range:
                                       range_epuck1 = current_range_epuck1
         
                                else:
                                       range_epuck1 = self.previous_range_epuck1
         
                                if sqrt((current_bearing_epuck1 - self.previous_bearing_epuck1) * (current_bearing_epuck1 - self.previous_bearing_epuck1)) >  self.Gamma_bearing*sqrt(self.previous_bearing_epuck1*self.previous_bearing_epuck1) + self.Delta_bearing:
                                       bearing_epuck1 = current_bearing_epuck1
         
                                else:
                                       bearing_epuck1 = self.previous_bearing_epuck1

                                self.previous_range_epuck1 = range_epuck1
                                self.previous_bearing_epuck1 = bearing_epuck1
                                self.second_run_epuck1 = False

                                self.alpha_1 = bernoulli.rvs(1)
                                self.Beta_1 = bernoulli.rvs(0.1)
                                self.Z_epuck1=[self.alpha_1*range_epuck1 + (1-self.alpha_1)*self.Beta_1*(-range_epuck1+0.01),self.alpha_1*bearing_epuck1 + (1-self.alpha_1)*self.Beta_1*(-bearing_epuck1+0.01)]
                               
                                if (self.flag_epuck1!= 0):
	                                self.ekf2w_localization_epuck1(self.moving_robot,self.stationary_robot,self.ut_epuck1,self.Z_epuck1, 
                                        self.deltaTheta_epuck1,self.deltaSteps_epuck1,self.x_pos_epuck1,self.y_pos_epuck1,self.theta_epuck1,self.camera_epuck1,self.flag_epuck1,self.alpha_1,self.Beta_1)
                                self.movingRobot=None
	                        self.stationaryRobot=None
	                        self.ut=[0,0]
    ...
    def   Localization_epuck2(self, ut_epuck2, x_pos_epuck2, y_pos_epuck2, theta_epuck2,flag_epuck2):
                                ...
                                if(self.second_run_epuck2):
                                      self.previous_range_epuck2 = Z_range_epuck2
                                      self.previous_bearing_epuck2 = Z_bearing_epuck2_norm
                                current_range_epuck2 = Z_range_epuck2
                                current_bearing_epuck2 = Z_bearing_epuck2_norm
 
                                if sqrt((current_range_epuck2 - self.previous_range_epuck2) * (current_range_epuck2 - self.previous_range_epuck2)) >                      self.Gamma_range*sqrt(self.previous_range_epuck2*self.previous_range_epuck2) + self.Delta_range:
                                       range_epuck2 = current_range_epuck2
         
                                else:
                                       range_epuck2 = self.previous_range_epuck2
         
                                if sqrt((current_bearing_epuck2 - self.previous_bearing_epuck2) * (current_bearing_epuck2 - self.previous_bearing_epuck2)) >  self.Gamma_bearing*sqrt(self.previous_bearing_epuck2*self.previous_bearing_epuck2) + self.Delta_bearing:
                                       bearing_epuck2 = current_bearing_epuck2
         
                                else:
                                       bearing_epuck2 = self.previous_bearing_epuck2

                                self.previous_range_epuck2 = range_epuck2
                                self.previous_bearing_epuck2 = bearing_epuck2
                                self.second_run_epuck2 = False

                                self.alpha_2 = bernoulli.rvs(1)
                                self.Beta_2 = bernoulli.rvs(0.1)
                                self.Z_epuck2 = [self.alpha_2*range_epuck2 + (1-self.alpha_2)*self.Beta_2*(-range_epuck2+0.01),self.alpha_2*bearing_epuck2 + (1-self.alpha_2)*self.Beta_2*(-bearing_epuck2+0.01)]
                                ...
                                if (self.flag_epuck2!= 0):
                                      ...
                                      self.theta_epuck2,self.camera_epuck2,self.flag_epuck2,self.alpha_2,self.Beta_2)
                                self.movingRobot=None
                                self.stationaryRobot=None
	                        self.ut=[0,0]
    ...
    def   Localization_epuck3(self, ut_epuck3, x_pos_epuck3, y_pos_epuck3, theta_epuck3,flag_epuck3):
                                ...
                                if(self.second_run_epuck3):
                                      self.previous_range_epuck3 = Z_range_epuck3
                                      self.previous_bearing_epuck3 = Z_bearing_epuck3_norm
                                current_range_epuck3 = Z_range_epuck3
                                current_bearing_epuck3 = Z_bearing_epuck3_norm
 
                                if sqrt((current_range_epuck3 - self.previous_range_epuck3) * (current_range_epuck3 - self.previous_range_epuck3)) >                      self.Gamma_range*sqrt(self.previous_range_epuck3*self.previous_range_epuck3) + self.Delta_range:
                                       range_epuck3 = current_range_epuck3
         
                                else:
                                       range_epuck3 = self.previous_range_epuck3
         
                                if sqrt((current_bearing_epuck3 - self.previous_bearing_epuck3) * (current_bearing_epuck3 - self.previous_bearing_epuck3)) >  self.Gamma_bearing*sqrt(self.previous_bearing_epuck3*self.previous_bearing_epuck3) + self.Delta_bearing:
                                       bearing_epuck3 = current_bearing_epuck3
         
                                else:
                                       bearing_epuck3 = self.previous_bearing_epuck3

                                self.previous_range_epuck3 = range_epuck3
                                self.previous_bearing_epuck3 = bearing_epuck3
                                self.second_run_epuck3 = False

                                self.alpha_3 = bernoulli.rvs(1)
                                self.Beta_3 = bernoulli.rvs(0.1)
                                self.Z_epuck3=[self.alpha_3*range_epuck3 + (1-self.alpha_3)*self.Beta_3*(-range_epuck3+0.01),self.alpha_3*bearing_epuck3 + (1-self.alpha_3)*self.Beta_3*(-bearing_epuck3+0.01)]
                                ...
                                if (self.flag_epuck3!= 0):
                                      ...
                                      self.camera_epuck3,self.flag_epuck3,self.alpha_3,self.Beta_3)
                                self.movingRobot=None
                                self.stationaryRobot=None
	                        self.ut=[0,0]
    ...
    def ekf2w_localization_epuck0(self,moving_robot,stationary_robot,ut_epuck0,Z_epuck0,deltaTheta_epuck0,deltaSteps_epuck0,x_pos_epuck0,y_pos_epuck0,theta_epuck0,camera_epuck0,flag_epuck0,alpha_0,Beta_0):
		...
		print Z_diff
                ...
                if abs(Z_diff[0,0])*abs(Z_diff[0,0]) + abs(Z_diff[1,0])*abs(Z_diff[1,0]) > 1.5:
                     rgb_led = UInt8MultiArray()
                     rgb_led.data = [100,0,0, 100,0,0, 100,0,0, 100,0,0]
                     self.led_epuck0.publish(rgb_led)
		...
		Kgain=  (sigma_bar)*(transpose(Hr))*(linalg.inv(S + (1-(alpha_0))*(Beta_0)*matrix([[100000000000000000,0],[0,100000000000000000]])*(1-(alpha_0))*(Beta_0)))
		...
		#   Update Covariance
                self.Robots[movingRobot].sigma.append((identity(3)-(alpha_0)*Kgain*Hr)*sigma_bar)
		...
		self.stepNumber=self.stepNumber+1
                ...
                ekf_odom.pose.pose.position = Point(1.5*self.Robots[movingRobot].mu[-1][0,0]-0.16+0.036-0.06-0.03, 1.2*self.Robots[movingRobot].mu[-1][0,1]+0.03, 0)
                self.endTime = time.time()
    ...
    def ekf2w_localization_epuck1(self,moving_robot,stationary_robot,ut_epuck1,Z_epuck1,deltaTheta_epuck1,deltaSteps_epuck1,x_pos_epuck1,y_pos_epuck1,theta_epuck1,camera_epuck1,flag_epuck1,alpha_1,Beta_1):
		...
		Z_diff=evaluateRelativePoseDifference(Z,Z_bar)
                ...
                if abs(Z_diff[0,0])*abs(Z_diff[0,0]) + abs(Z_diff[1,0])*abs(Z_diff[1,0]) > 1.5:
                     rgb_led = UInt8MultiArray()
                     rgb_led.data = [100,0,0, 100,0,0, 100,0,0, 100,0,0]
                     self.led_epuck1.publish(rgb_led)
		...
		#   Calculate Kalman Gain (Kgain)
		Kgain=  (sigma_bar)*(transpose(Hr))*(linalg.inv(S + (1-(alpha_1))*(Beta_1)*matrix([[1000000000000,0],[0,1000000000000]])*(1-(alpha_1))*(Beta_1)))
                print Kgain
		...
		#   Update Covariance
                self.Robots[movingRobot].sigma.append((identity(3)-(alpha_1)*Kgain*Hr)*sigma_bar)
		...
		self.stepNumber=self.stepNumber+1
                ...
                ekf_odom.header.stamp = rospy.Time.now()
                ekf_odom.header.frame_id = "base_link"
                ekf_odom.pose.pose.position = Point(1*self.Robots[movingRobot].mu[-1][0,0]-0.026+0.02-0.025, self.Robots[movingRobot].mu[-1][0,1], 0)
                self.endTime = time.time()
    ...
    def ekf2w_localization_epuck2(self,moving_robot,stationary_robot,ut_epuck2,Z_epuck2,deltaTheta_epuck2,deltaSteps_epuck2,x_pos_epuck2,y_pos_epuck2,theta_epuck2,camera_epuck2,flag_epuck2,alpha_2,Beta_2):
		...
		print Z_diff
                ...
                if abs(Z_diff[0,0])*abs(Z_diff[0,0]) + abs(Z_diff[1,0])*abs(Z_diff[1,0]) > 1.5:
                     rgb_led = UInt8MultiArray()
                     rgb_led.data = [100,0,0, 100,0,0, 100,0,0, 100,0,0]
                     self.led_epuck2.publish(rgb_led)
		...
		#   Calculate Kalman Gain (Kgain)
		Kgain=  (sigma_bar)*(transpose(Hr))*(linalg.inv(S + (1-(alpha_2))*(Beta_2)*matrix([[1000000000000,0],[0,1000000000000]])*(1-(alpha_2))*(Beta_2)))
		...
		#   Update Covariance
                self.Robots[movingRobot].sigma.append((identity(3)-(alpha_2)*Kgain*Hr)*sigma_bar)
                print self.Robots[movingRobot].sigma
		print "Robot Number:",movingRobot
		print "Odometers",self.Robots[movingRobot].mu_expected[-1][0,0],self.Robots[movingRobot].mu_expected[-1][0,1],self.Robots[movingRobot].mu_expected[-1][0,2]*(180/pi)
		print "Filtered:", self.Robots[movingRobot].mu[-1][0,0],self.Robots[movingRobot].mu[-1][0,1],self.Robots[movingRobot].mu[-1][0,2]*(180/pi)
		...
		self.stepNumber=self.stepNumber+1
                ...
                ekf_odom.header.stamp = rospy.Time.now()
                ekf_odom.header.frame_id = "base_link"
                ekf_odom.pose.pose.position = Point(1.575*self.Robots[movingRobot].mu[-1][0,0]-0.268+0.14-0.017-0.02-0.04, self.Robots[movingRobot].mu[-1][0,1], 0)
                self.endTime = time.time()
    ...
    def ekf2w_localization_epuck3(self,moving_robot,stationary_robot,ut_epuck3,Z_epuck3,deltaTheta_epuck3,deltaSteps_epuck3,x_pos_epuck3,y_pos_epuck3,theta_epuck3,camera_epuck3,flag_epuck3,alpha_3,Beta_3):
		...
		print Z_diff
                ...
                if abs(Z_diff[0,0])*abs(Z_diff[0,0]) + abs(Z_diff[1,0])*abs(Z_diff[1,0]) > 1.5:
                     rgb_led = UInt8MultiArray()
                     rgb_led.data = [100,0,0, 100,0,0, 100,0,0, 100,0,0]
                     self.led_epuck3.publish(rgb_led)
		...
		#   Calculate Kalman Gain (Kgain)
		Kgain=  (sigma_bar)*(transpose(Hr))*(linalg.inv(S + (1-(alpha_3))*(Beta_3)*matrix([[1000000000000,0],[0,1000000000000]])*(1-(alpha_3))*(Beta_3)))
		...
		#   Update Covariance
                self.Robots[movingRobot].sigma.append((identity(3)-(alpha_3)*Kgain*Hr)*sigma_bar)
                print self.Robots[movingRobot].sigma
		print "Robot Number:",movingRobot
		print "Odometers",self.Robots[movingRobot].mu_expected[-1][0,0],self.Robots[movingRobot].mu_expected[-1][0,1],self.Robots[movingRobot].mu_expected[-1][0,2]*(180/pi)
		print "Filtered:", self.Robots[movingRobot].mu[-1][0,0],self.Robots[movingRobot].mu[-1][0,1],self.Robots[movingRobot].mu[-1][0,2]*(180/pi)
		...
		self.stepNumber=self.stepNumber+1
                ...
                ekf_odom.header.stamp = rospy.Time.now()
                ekf_odom.header.frame_id = "base_link"
                ekf_odom.pose.pose.position = Point(1.3*self.Robots[movingRobot].mu[-1][0,0]-0.152+0.04-0.04, 1.2*self.Robots[movingRobot].mu[-1][0,1], 0)
                self.endTime = time.time()
